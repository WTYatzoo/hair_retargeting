...
class io
{
 public:
  ...
  int getVertexAndQuadFromObj(std::vector<vertex > &myvertexs,std::vector<quad > &myquads,const std::string name);
  int getVertexAndHairFromObj(std::vector<vertex > &myvertexs_hair,std::vector<e > &myedges_hair,const std::string name);
  int saveHairAsVTK(std::vector<vertex > &myvertexs_hair,std::vector<e > &myedges_hair,const std::string name);
